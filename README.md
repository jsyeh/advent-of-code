...
|第幾天| 主題 |   解釋  |
|-----| --- | ------  |
|Day 1|投石機| 你想解決問題，竟被裝進投石機，計算座標 [code](https://leetcode.com/playground/NbK5Fk4q)|
|Day 2|立方體| 猜猜有幾個方塊 [code](https://leetcode.com/playground/9WDiQc5P)|
|Day 3| 齒輪 |在地圖中找齒輪，算齒輪比 [code](https://leetcode.com/playground/o2MioXoa)|
|Day 4|刮刮卡|卡片可得到幾分 [code](https://leetcode.com/playground/LvfQBMxc)|
|Day 5|種子施肥|照著配方栽種 [code](https://leetcode.com/playground/27Q8qWiE)|
|Day 6|玩具船|比賽破紀綠的方法有幾種 [code](https://leetcode.com/playground/jib3ayAN)|
|Day 7|駱駝卡|計算牌可賺多少獎金 [code](https://leetcode.com/playground/5zN4bSDs)|
|Day 8| 鬧鬼 |照著地圖，走幾步才能逃離 [code](https://leetcode.com/playground/E8WPwAYX)|
|Day 9| 維護 |從歷史記錄，預測下一個值 [code](https://leetcode.com/playground/2YiDrHAL)|
|Day 10|管子迷宮|管子最遠走多遠？圍出多大面積？ [code](https://leetcode.com/playground/nM22dALs)|
|Day 11|天文觀測|宇宙正在擴張，全部走到的最短路徑 [code](https://leetcode.com/playground/79ExVEjx) TLE|
|Day 12|溫泉/彈簧|計算彈簧的所有可能排列組合 [code](https://leetcode.com/playground/TFeXi22a)|
|Day 13|哪裡壞了|有一堆鏡子，找到可能的鏡子位置 [code](https://leetcode.com/playground/h2LBRasK)|
|Day 14|拋物面鏡|石頭滾來滾去、影響配重，最重是多少 [code](https://leetcode.com/playground/HtuBBNSe)|
|Day 15|一堆鏡片|鏡片上有標籤，配出能對焦的光線是多少 [code](https://leetcode.com/playground/NrB8pJAV)|
|Day 16|地板變岩漿|有幾塊地板，在被光照過後變成岩漿， [code](https://leetcode.com/playground/VmCmUDEc)|
|Day 17|坩堝|裝岩漿的坩堝，邊走邊降溫，希望減少熱量損失 [code](https://leetcode.com/playground/LgGQfjLy)|
|Day 18|熔岩潟湖|照著挖掘計畫挖，容量有多大？[code](https://leetcode.com/playground/NrnvLJz9)缺part2|
|Day 19|滿滿的零件|一堆零件，照著規則挑選，會得到幾分？ [code](https://leetcode.com/playground/ZrL9HWoC)缺part2|
|Day 20|脈衝|一堆零件接在一起，高低脈衝訊號傳播的狀況 [code](https://leetcode.com/playground/CxjzhZ4h)缺part2|
|Day 21|計步器|超大的花園，要走幾步 [code](https://leetcode.com/playground/EXSPU4ZD)缺part2|
|Day 22|沙磚落下|掉落中的磚，卡住時，要怎麼打碎 [code](https://leetcode.com/playground/TgM2ou8g)|
|Day 23|走很遠|回到雪島，散步時，可以走多遠 [code](https://leetcode.com/playground/LNwHfZqY) [part2](https://leetcode.com/playground/PevzK4qv)|
|Day 24|怎麼可能|冰雹相撞的可能性 [code](https://leetcode.com/playground/Q37sf9kL)|
|Day 25|超載/積雪|一堆零件相接，但星星不夠，斷開三根線，就可分成2堆 [code](https://leetcode.com/playground/W6bJkBcy)缺part2|

|[Day1](https://leetcode.com/playground/NbK5Fk4q)投石機|
